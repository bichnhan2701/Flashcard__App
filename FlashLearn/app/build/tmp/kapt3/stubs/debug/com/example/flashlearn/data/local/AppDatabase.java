...
@androidx.room.Database(entities = {com.example.flashlearn.data.local.entity.FlashcardEntity.class, com.example.flashlearn.data.local.entity.CategoryEntity.class, com.example.flashlearn.data.local.entity.MiniQuizResultEntity.class}, version = 8, exportSchema = false)
