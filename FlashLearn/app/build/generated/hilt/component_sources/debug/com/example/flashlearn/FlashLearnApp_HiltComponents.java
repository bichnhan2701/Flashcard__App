...
import com.example.flashlearn.di.AuthModule;
import com.example.flashlearn.di.DatabaseModule;
import com.example.flashlearn.di.RepositoryModule;
import com.example.flashlearn.di.UseCaseModule;
...
public final class FlashLearnApp_HiltComponents {
  private FlashLearnApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements FlashLearnApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          AddFolderViewModel_HiltModules.KeyModule.class,
          AuthViewModel_HiltModules.KeyModule.class,
          CategoryDetailViewModel_HiltModules.KeyModule.class,
          EditFolderDetailViewModel_HiltModules.KeyModule.class,
          ActivityCBuilderModule.class,
          ViewModelCBuilderModule.class,
          FlashcardFormViewModel_HiltModules.KeyModule.class,
          FlashcardReviewViewModel_HiltModules.KeyModule.class,
          HiltWrapper_ActivityRetainedComponentManager_LifecycleModule.class,
          HiltWrapper_SavedStateHandleModule.class,
          HomeViewModel_HiltModules.KeyModule.class,
          MiniQuizViewModel_HiltModules.KeyModule.class,
          NotificationViewModel_HiltModules.KeyModule.class,
          ProgressDetailViewModel_HiltModules.KeyModule.class,
          ProgressViewModel_HiltModules.KeyModule.class,
          QuizHistoryViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          AddFolderViewModel_HiltModules.BindsModule.class,
          AuthViewModel_HiltModules.BindsModule.class,
          CategoryDetailViewModel_HiltModules.BindsModule.class,
          EditFolderDetailViewModel_HiltModules.BindsModule.class,
          FlashcardFormViewModel_HiltModules.BindsModule.class,
          FlashcardReviewViewModel_HiltModules.BindsModule.class,
          HiltWrapper_HiltViewModelFactory_ViewModelModule.class,
          HomeViewModel_HiltModules.BindsModule.class,
          MiniQuizViewModel_HiltModules.BindsModule.class,
          NotificationViewModel_HiltModules.BindsModule.class,
          ProgressDetailViewModel_HiltModules.BindsModule.class,
          ProgressViewModel_HiltModules.BindsModule.class,
          QuizHistoryViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
